      ...
      <section className={styles.login}>
        <div className={styles.loginBox}>
          ...
          <form onSubmit={handleSignUp}>
            ...
            <button type="submit" disabled={loading}>{loading ? t.auth.creatingAccount : t.auth.signUp}</button>
          </form>
          ...
          <span>{t.auth.haveAccount} <Link href="/sign-in">{t.auth.signInLink}</Link></span>
        </div>
      </section>
    </div>
  );
